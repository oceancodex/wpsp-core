@props(['routeParameters', 'routing', 'routingIdx', 'routingIteration'])

<div class="flex flex-col gap-3" style="margin-top: -40px;">
    <h2 class="text-lg font-semibold">Routing #{{ $routingIteration }} - Parameters</h2>
    @if ($routeParameters)
