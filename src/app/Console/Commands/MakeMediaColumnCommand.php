...
class MakeMediaColumnCommand extends Command {
	...
	public function handle() {
		...
		if (!$name) {
			$name = $this->ask('Please enter the name of the media column (Eg: custom_media_column)');
		 ...
		 * ---
		 */
		$this->addClassToRoute('MediaColumns', 'media_columns', $func, $use);

		// Done.
		$this->info('Created new media column: "' . $name . '"');
