 ...
 */
abstract class BaseMediaColumn extends BaseInstances {
	...
	public function init($column_name = null) {
		...
		if ($column_name) {
			 ...
			 */
			add_filter('manage_upload_columns', function($columns) use ($column_name) {
				$new_columns = [];
				$inserted = false;
			 ...
			 * The column content.
			 */
			add_filter('manage_media_custom_column', function($columnName, $postId) use ($requestPath, $column_name) {
