	...
	public function init($column_name = null) {
		...
		if ($column_name) {
			foreach ($this->taxonomies as $taxonomy) {
				 ...
				 */
				add_filter('manage_edit-'.$taxonomy.'_columns', function($columns) use ($column_name) {
					$new_columns = [];
					$inserted = false;
				 ...
				 * The column content.
				 */
				add_filter('manage_' . $taxonomy . '_custom_column', function($content, $columnName, $termId) use ($requestPath, $column_name) {
